...
const Release = ({ name, imageUrl, authors }) => {
    return (
        <div className='release'>
            <div className='release__control'>
                <div className='release__play song-button-play song-button-play'>
            ...
            <img
                src={require(`../assets/img/releases/release${imageUrl}.png`)}
                alt='Release Cover' className='release__image' />
            <div className='release__info'>
                <h3 title={name} className='release__name'>{name}</h3>
                <p className='release__authors'>
                    {
